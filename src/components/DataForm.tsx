            ...
            <Col className="col-8" >
                ...
                <Form className="d-flex flex-column">
                    <Form.Group controlId="date">
                        ...
                        <Form.Control type="month" lang="en" min="2020-01" max={currentDate} value={date} onChange={(e)=>setDate(e.target.value)} />
                    </Form.Group>
                    ...
                    <Link to={"/display/" + date + "/" + country[1]} className="align-self-center">
                        <Button variant="primary" className="px-4">Submit</Button>
                    </Link>
                </Form>
            </Col>
        </Row>
